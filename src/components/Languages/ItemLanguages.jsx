export default function Item({ data, current, onDoubleClick }) {
    console.log(data);
    return (
        <li onDoubleClick={onDoubleClick}>
            <div className={`block cursor-pointer hover:bg-gray-50 transition duration-200 ${current === true ? "bg-blue-50" : ""}`}>
                <div className="px-4 py-4 sm:px-6">
                    <div className="flex items-center justify-between">
                        <div className="truncate text-lg font-medium text-indigo-600">{data.language}</div>
