...
export default function CreatedWord({ word, setWord, setPageStatus }) {
  ...
  return (
    <div className="flex justify-center items-center flex-col my-2">
      {/* Computer version */}
      <div className="cw-computer w-full">
      ...
      <div className="cw-phone mx-6">
        <div>
          ...
          <div>
            <span className="p-2 mr-2 font-semibold">is it used in any official-literary source?</span>
          </div>
          <div>
            <div className="mb-6">
              <textarea
          ...
          <div>
            <div className="mb-6">
              <button
                className="float-right bg-transparent bg-blue-500 hover:bg-blue-700 font-semibold text-white border border-blue-500 border-transparent text-sm px-4 py-2 rounded shadow outline-none focus:outline-none ease-linear transition-all duration-150"
                type="button"
                onClick={() => {
                  setCookie("word", "", 0);
                  setPageStatus("new");
