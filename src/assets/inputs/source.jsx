...
export default function InputSource({ word, setWord, resources }) {
    ...
    return (
        <div className="sm:grid sm:grid-cols-3 sm:gap-2 lg:inline-block lg:mt-4 lg:mr-8 lg:w-[clamp(calc(850px/3-2rem),calc(33.3333%-2rem),600px)]">
            <div className="sm:col-span-1">
                <span className="p-2 mr-2 font-semibold sm:float-right lg:float-left">{t("is it used in any official or literary source?")}</span>
            </div>
            <div className="sm:col-span-2">
                <div className="mb-6">
                    <textarea
                        ...
                        onChange={(e) => setWord({ ...word, example: { ...word.example, example: e.target.value } })}
                    ...
                    ></textarea>
                    <select
                        value={word.example.resource || ""}
                        onChange={(e) => setWord({ ...word, example: { ...word.example, resource: e.target.value } })}
                    ...
                    <input
                        ...
                        onChange={(e) => setWord({ ...word, example: { ...word.example, page: e.target.value } })}
