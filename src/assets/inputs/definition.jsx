    ...
    return (
        <div className="sm:grid sm:grid-cols-3 sm:gap-2 lg:inline-block lg:mt-4 lg:mr-8 lg:w-[clamp(calc(850px/3-2rem),calc(33.3333%-2rem),600px)]">
            <div className="sm:col-span-1">
                <span className="p-2 mr-2 font-semibold sm:float-right lg:float-left">{t("definition")}:</span>
            </div>
            <div className="sm:col-span-2">
                <div className="mb-6">
                    <textarea
                        ...
                        onChange={(e) => setWord({ ...word, definition: { ...word.definition, definition: e.target.value } })}
                    ...
                    <select
                        ...
                        onChange={(e) => setWord({ ...word, definition: { ...word.definition, resource: e.target.value } })}
                    ...
                    <input
                        ...
                        onChange={(e) => setWord({ ...word, definition: { ...word.definition, page: e.target.value } })}
                        placeholder={t("page")}
